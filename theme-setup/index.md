...
A [sample index page](blog.chrisbriggsy.com/posts/) listing all posts grouped by the year they were published has been provided. The name can be customized to your liking by editing a few references. For example, to change **Posts** to **Writing** update the following:
...
<figure>
  <img src="blog.chrisbriggsy.com/images/paragraph-indent.png" alt="screen shot of paragraphs with default indent style set">
...
<figure>
  <img src="blog.chrisbriggsy.com/images/paragraph-no-indent.png" alt="screen shot of paragraphs with indent style disabled">
